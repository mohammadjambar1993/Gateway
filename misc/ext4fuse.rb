# a helper script to install macfuse and ext4fuse on macosx via homebrew
# this is primarily used to mount pi4 on macos to inspect within the context of this project
# ref: https://github.com/gerard/ext4fuse/issues/66#issuecomment-819943409
# run:
# brew install --cask macfuse
# brew install --formula --build-from-source ./ext4fuse.rb
# guide on how to mount pi sd on macosx
