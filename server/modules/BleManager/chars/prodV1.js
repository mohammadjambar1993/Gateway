...
const chars = {
  ...
  LOG: makeUUID('6804'),
  HEART_RATE_ONE: makeUUID('6830'),
  HEART_RATE_TWO: makeUUID('6831'),
  ECG_ONE: makeUUID('6820'),
  ECG_TWO: makeUUID('6821'),
  STEPS: makeUUID('6832'),
  ACTIVITY_TYPE: makeUUID('6833'),
  ACCELEROMETER: makeUUID('6822'),
  OP_CODES: {
